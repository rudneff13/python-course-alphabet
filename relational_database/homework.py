...
def task_8_count_customers_by_city(cur):
    ...
    # cur.execute("SELECT COUNT(customerid), city FROM customers GROUP BY city ORDER BY COUNT(address) DESC;")
    return cur.fetchall()
...
def task_9_count_customers_by_country_with_than_10_customers(cur):
    ...
    Returns: 3 records
    """
    cur.execute("SELECT country, COUNT(customerid) FROM customers GROUP BY country HAVING COUNT(*)>10;")
    return cur.fetchall()
