    ...
    * Implement get_average_speed and return average_speed
    ...
    def eat(self, product):
        ...
        if product in product_dict.keys():
            saturation_level = [self._increase_saturation_level(v) for k, v in product_dict.items() if product == k][0]
        else:
            print("That's not a food for your cat")
